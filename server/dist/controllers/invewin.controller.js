...
exports.InvewinController = void 0;
...
var InvewinController;
(function (InvewinController) {
    function auth() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, http.post(process.env.INVEWIN_API_URL + "/auth", body)];
                    case 1:
                        data = (_a.sent()).data;
    ...
    InvewinController.auth = auth;
    function authCustom(password, userName, clientSecret) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    InvewinController.authCustom = authCustom;
})(InvewinController || (exports.InvewinController = InvewinController = {}));
